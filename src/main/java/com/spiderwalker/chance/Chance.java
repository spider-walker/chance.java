...
//            }
     ...
     */
    public List<?> n(Supplier fn, Supplier<Integer> d4) {
        int size = d4.get();
        return n(fn, size);
    }
    ...
    public int weighted(Object[] arr, int[] weights) {
    ...
    public String semver(Map<String, Object> options) {
        ...
        if (MapUtils.get(options, "include_prerelease") != null) {
            ...
            prerelease = String.valueOf(weighted(arr, weights));
        }
...
//
    ...
    public <T> T country(Map<String, Object> options) {
        options = MapUtils.initOptions(options, new HashMap<>());
        Map<String, String> country = pickone(countries());
        return (boolean) MapUtils.get(options, "raw") ?
                (T) country : (T) (MapUtils.get(options, "full") ? country.get("name")
